...
bool CJumpPoint::JumpCornerSearch(int PosX, int PosY, BYTE SearchDir, DWORD SearchedColor) {
	...
	case DIR_LL:
	{
		for (;;) {
			...
			// 코너라면 true
			if (pNode->iColor == WHITE)
				pNode->iColor = SearchedColor;
			if (isCorner(PosX, PosY, DIR_LL) == true)
				return true;
	...
	case DIR_DD:
	{
		for (;;) {
			...
			// 코너라면 true
			pNode->iColor = SearchedColor;
			if (isCorner(PosX, PosY, DIR_DD) == true) {
				retval = true;
				break;
			}
...
bool CJumpPoint::JumpLL(int iPosX, int iPosY, NODE *pParent, NODE **pFindNode, DWORD SearchedColor) {
	...
	for(;;) {
		...
		if (pNowNode->iColor != RED || pNowNode->iColor != GREEN ||
			pNowNode->iColor != BLUE || pNowNode->iColor != YELLOW)
			pNowNode->iColor = SearchedColor;
...
bool CJumpPoint::JumpRR(int iPosX, int iPosY, NODE *pParent, NODE **pFindNode, DWORD SearchedColor) {
...
bool CJumpPoint::JumpUU(int iPosX, int iPosY, NODE *pParent, NODE **pFindNode, DWORD SearchedColor) {
...
bool CJumpPoint::JumpDD(int iPosX, int iPosY, NODE *pParent, NODE **pFindNode, DWORD SearchedColor) {
...
bool CJumpPoint::JumpLU(int iPosX, int iPosY, NODE *pParent, NODE **pFindNode, DWORD SearchedColor) {
	...
	for (;;) {
		...
		if (pNowNode->iColor != RED || pNowNode->iColor != GREEN ||
			pNowNode->iColor != BLUE || pNowNode->iColor != YELLOW)
			pNowNode->iColor = SearchedColor;
		bool Corner = isCorner(PosX, PosY, DIR_LU);
		if (Corner == true) {
			pNowNode->byParentDir = DIR_LU;
			pNowNode->pParent = pParent;
			pNowNode->iX = PosX;
			pNowNode->iY = PosY;
			pNowNode->G = iG;
		...
		bool Horizon = JumpCornerSearch(PosX - 1, PosY, DIR_LL, SearchedColor);
		bool Vertical = JumpCornerSearch(PosX, PosY - 1, DIR_UU, SearchedColor);

		if (Horizon == true || Vertical == true) {
...
bool CJumpPoint::JumpUR(int iPosX, int iPosY, NODE *pParent, NODE **pFindNode, DWORD SearchedColor) {
	...
	for (;;) {
		...
		if (pNowNode->iColor != RED || pNowNode->iColor != GREEN ||
			pNowNode->iColor != BLUE || pNowNode->iColor != YELLOW)
			pNowNode->iColor = SearchedColor;
		bool Corner = isCorner(PosX, PosY, DIR_UR);
		if (Corner == true) {
			pNowNode->byParentDir = DIR_UR;
			pNowNode->pParent = pParent;
			pNowNode->iX = PosX;
			pNowNode->iY = PosY;
			pNowNode->G = iG;
		...
		bool Horizon = JumpCornerSearch(PosX + 1, PosY, DIR_RR, SearchedColor);
		bool Vertical = JumpCornerSearch(PosX, PosY - 1, DIR_UU, SearchedColor);
...
bool CJumpPoint::JumpRD(int iPosX, int iPosY, NODE *pParent, NODE **pFindNode, DWORD SearchedColor) {
	...
	for (;;) {
		...
		if (pNowNode->iColor != RED || pNowNode->iColor != GREEN ||
			pNowNode->iColor != BLUE || pNowNode->iColor != YELLOW)
			pNowNode->iColor = SearchedColor;
		bool Corner = isCorner(PosX, PosY, DIR_RD);
		if (Corner == true) {
			pNowNode->byParentDir = DIR_RD;
			pNowNode->pParent = pParent;
			pNowNode->iX = PosX;
			pNowNode->iY = PosY;
			pNowNode->G = iG;
		...
		bool Horizon = JumpCornerSearch(PosX + 1, PosY, DIR_RR, SearchedColor);
		bool Vertical = JumpCornerSearch(PosX, PosY + 1, DIR_DD, SearchedColor);
...
bool CJumpPoint::JumpDL(int iPosX, int iPosY, NODE *pParent, NODE **pFindNode, DWORD SearchedColor) {
	...
	for (;;) {
		...
		if (pNowNode->iColor != RED || pNowNode->iColor != GREEN ||
			pNowNode->iColor != BLUE || pNowNode->iColor != YELLOW)
			pNowNode->iColor = SearchedColor;
		bool Corner = isCorner(PosX, PosY, DIR_DL);
		if (Corner == true) {
			pNowNode->byParentDir = DIR_DL;
			pNowNode->pParent = pParent;
			pNowNode->iX = PosX;
			pNowNode->iY = PosY;
			pNowNode->G = iG;
