...
typedef struct stNETWORK_PACKET_PAYLOAD
{
	DWORD	ID;
	BYTE	Direction;
	WORD	X;
...
#pragma pack(push,1)
struct stPACKET_CREATE_CHARACTER
{
	DWORD	ID;
	BYTE	Direction;
	short	X;
...
#pragma pack(push,1)
struct stPACKET_DELETE_CHARACTER
{
	DWORD	ID;
};
#pragma pack(pop)
